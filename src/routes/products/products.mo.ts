...
// export const registerOneRegularProductttt = async (body: PostReqNewProduct): Promise<NewProductSummary> => {
//   // 完全新規登録（通常商品）
//   const newProductSummary = await db.tx('regular-product-registration', async (t) => {
//     const basicInput = formatBasicProductData(body);
...
//     const productInput = formatProductData(body, basicProductsTbRow);
...
//     const skusInput = formatSkusData(body, productsTbRow);
