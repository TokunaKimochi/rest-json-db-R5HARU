...
describe('住所を抜き出し、厳密比較', () => {
  ...
  it('東京都新宿区新宿4-1-6 と厳密等価', () => {
    const result = extractAddress('東京都新宿区新宿4-1-6-23Ｆ');
    expect(result).toBe('東京都新宿区新宿4-1-6');
  });
  ...
  it('東京都千代田区一番町八 と厳密等価', () => {
    const result = extractAddress('〒102-0082　東京都千代田区一番町八Ｂ１Ｆ');
    expect(result).toBe('東京都千代田区一番町八');
  });
